...
| [`multimux`](multimux/) | [![crates.io](https://img.shields.io/crates/v/multimux.svg)](https://crates.io/crates/multimux) | [![docs.rs](https://img.shields.io/docsrs/multimux)](https://docs.rs/multimux) | Multi-input (RTSP/RTP/TS-UDP/TS-HTTP/SRT/HLS-pull/DASH-pull/Smooth-pull/RTMP), multi-output (LL-HLS/DASH/LL-DASH) just-in-time repackaging HTTP origin (tokio + axum), with shared output auth and an external scheme plugin registry. **Independently versioned.** |
