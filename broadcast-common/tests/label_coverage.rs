...
//!
//! Skip list:
//! SKIP is empty: this crate's one public enum (`BitError`) already carries a
//! hand-written `Display` impl (a structured error message), which this
//! guard's `has_impl` check recognizes directly.
