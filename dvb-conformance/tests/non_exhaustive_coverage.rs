//! Drift-guard: every `pub enum` in dvb-conformance must carry `#[non_exhaustive]`.
//!
...
///
/// This list is empty: every public enum in dvb-conformance should be non-exhaustive.
const SKIP: &[&str] = &[];
