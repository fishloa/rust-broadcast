...
- **mpeg-pes** — PES depacketization + PTS/DTS (ISO/IEC 13818-1 §2.4.3); `no_std`, depends only on broadcast-common; independently versioned. (`dvb-pes` is a deprecated re-export shim at 0.1.2.)
...
- **cc-data** — DVB closed-caption carriage cc_data() (ETSI TS 101 154 Table B.9): typed CEA-608/708 triplets + 608/708 split; `no_std`, depends only on broadcast-common; independently versioned. (`dvb-cc` is a deprecated re-export shim at 0.2.1.)
