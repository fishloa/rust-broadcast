...
- **timed-metadata** — Convert DPI/timed-metadata signalling between SCTE-35, HLS `EXT-X-DATERANGE` (RFC 8216 §4.4.5.1), and DASH `emsg` (DASH-IF IOP Part 10; SCTE 214 part unverified, #951); lossless round-trips, 33-bit PTS wrap-unroll via `Timeline`; `no_std`; independently versioned.
