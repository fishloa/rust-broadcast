...
declare_descriptors! {'a;
    ...
    Sl = 0x1E => crate::descriptors::sl::SlDescriptor,
    Fmc = 0x1F => crate::descriptors::fmc::FmcDescriptor,
    ExternalEsId = 0x20 => crate::descriptors::external_es_id::ExternalEsIdDescriptor,
    ...
    FlexMuxTiming = 0x2C => crate::descriptors::flex_mux_timing::FlexMuxTimingDescriptor,
