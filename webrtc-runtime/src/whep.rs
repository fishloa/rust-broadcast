...
pub mod status {
    /// Resource created; the SDP offer/answer is in the response body.
    ...
    /// The server is counter-offering rather than accepting the client's SDP.
    pub const NOT_ACCEPTABLE: u16 = 406;
    /// No publisher is currently active for the requested resource.
