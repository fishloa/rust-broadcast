...
|---|---|---|
|  PES Packet() { packet_start_code_prefix | 24 | bslbf  |
|  stream_id | 8 | uimsbf  |
|  PES Packet_length | 16 | uimsbf  |
...
|  && stream_id != ITU-T Rec. H.222.1 type E stream) { '10' | 2 | bslbf  |
|  PES scrambling_control | 2 | bslbf  |
...
|  if (PTS_DTS_flags == '10') { '0010' | 4 | bslbf  |
...
|  Syntax | No. of bits | Mnemonic  |
| --- | --- | --- |
|  if ( PES_extension_flag == '1') { PES_private_data_flag | 1 | bslbf  |
...
|  } |  |   |
|  if (pack_header_field_flag == '1') { pack_field_length | 8 | uimsbf  |
|  pack_header() |  |   |
|  } |  |   |
...
|  if ( stream_id_extension_flag == '0') { stream_id_extension | 7 | uimsbf  |
|  } |  |   |
|  else { reserved | 6 | bslbf  |
|  tref_extension_flag | 1 | bslbf  |
|  if ( tref_extension_flag == '0') { reserved | 4 | bslbf  |
|  TREF[32..30] | 3 | bslbf  |
|  marker_bit | 1 | bslbf  |
|  TREF[29..15] | 15 | bslbf  |
|  marker_bit | 1 | bslbf  |
...
|  marker_bit | 1 | bslbf  |
|  } |  |   |
|  } for ( i = 0; i < N3; i++) { reserved | 8 | bslbf  |
|  } |  |   |
|  } |  |   |
|  } |  |   |
...
|  for (i = 0; i < PES_packet_length; i++) { PES_packet_data_byte | 8 | bslbf  |
|  } |  |   |
